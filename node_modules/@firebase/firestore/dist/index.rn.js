...
import { base64 as a, getUA as u, isIndexedDBAvailable as h, isSafari as l, isMobileCordova as f, isReactNative as d, isElectron as w, isIE as _, isUWP as m, isBrowserExtension as g, createMockUserToken as y, getModularInstance as p, deepEqual as E } from "@firebase/util";

import { XhrIo as T, EventType as I, ErrorCode as A, createWebChannelTransport as R, getStatEventTarget as b, FetchXmlHttpFactory as P, WebChannel as v, Event as V, Stat as S } from "@firebase/webchannel-wrapper";
 ...
 * limitations under the License.
 */
const N = new o("@firebase/firestore");
 ...
 */ class vt {
    ...
    static fromPath(t) {
        return new vt(ht.fromString(t));
    }
    static fromName(t) {
        return new vt(ht.fromString(t).popFirst(5));
    }
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function St(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            ...
            if ("doubleValue" in t && "doubleValue" in e) {
                const n = pt(t.doubleValue), s = pt(e.doubleValue);
      ...
      case 9 /* ArrayValue */ :
        return nt(t.arrayValue.values || [], e.arrayValue.values || [], St);
...
function Ct(t, e) {
    ...
    switch (n) {
      ...
      case 2 /* NumberValue */ :
        return function(t, e) {
            const n = pt(t.integerValue || t.doubleValue), s = pt(e.integerValue || e.doubleValue);
      ...
      case 3 /* TimestampValue */ :
        return Nt(t.timestampValue, e.timestampValue);
      ...
      case 8 /* GeoPointValue */ :
        return function(t, e) {
            const n = et(pt(t.latitude), pt(e.latitude));
            if (0 !== n) return n;
            return et(pt(t.longitude), pt(e.longitude));
...
function Nt(t, e) {
    ...
    const n = yt(t), s = yt(e), i = et(n.seconds, s.seconds);
...
/** Creates a deep copy of `source`. */ function Ut(t) {
    ...
    if (t.mapValue) {
        ...
        return ct(t.mapValue.fields, ((t, n) => e.mapValue.fields[t] = Ut(n))), e;
    }
    if (t.arrayValue) {
        const e = {
            arrayValue: {
 ...
 */ class qt {
     ...
     */    setAll(t) {
        ...
        t.forEach(((t, i) => {
            ...
            t ? n[i.lastSegment()] = Ut(t) : s.push(i.lastSegment());
        }));
 ...
 */ class jt {
     ...
     */    static newInvalidDocument(t) {
        return new jt(t, 0 /* INVALID */ , rt.min(), qt.empty(), 0 /* SYNCED */);
    }
    /**
     * Creates a new document that is known to exist with the given data at the
     * given version.
     */    static newFoundDocument(t, e, n) {
        return new jt(t, 1 /* FOUND_DOCUMENT */ , e, n, 0 /* SYNCED */);
    }
    /** Creates a new document that is known to not exist at the given version. */    static newNoDocument(t, e) {
        return new jt(t, 2 /* NO_DOCUMENT */ , e, qt.empty(), 0 /* SYNCED */);
    }
    /**
     ...
     */    static newUnknownDocument(t, e) {
        return new jt(t, 3 /* UNKNOWN_DOCUMENT */ , e, qt.empty(), 2 /* HAS_COMMITTED_MUTATIONS */);
    }
    /**
    ...
    clone() {
        return new jt(this.key, this.documentType, this.version, this.data.clone(), this.documentState);
    }
    toString() {
...
class Yt extends class {} {
     ...
     */    static create(t, e, n) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.R(t, e, n) : new Zt(t, e, n) : "array-contains" /* ARRAY_CONTAINS */ === e ? new se(t, n) : "in" /* IN */ === e ? new ie(t, n) : "not-in" /* NOT_IN */ === e ? new re(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new oe(t, n) : new Yt(t, e, n);
    }
    static R(t, e, n) {
    ...
    matches(t) {
        ...
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.P(Ct(e, this.value)) : null !== e && Vt(this.value) === Vt(e) && this.P(Ct(e, this.value));
...
/** A Filter that implements the array-contains operator. */ class se extends Yt {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return Ft(e) && Dt(e.arrayValue, this.value);
    }
}
...
/** A Filter that implements the array-contains-any operator. */ class oe extends Yt {
    ...
    matches(t) {
        const e = t.data.field(this.field);
        return !(!Ft(e) || !e.arrayValue.values) && e.arrayValue.values.some((t => Dt(this.value.arrayValue, t)));
    }
}
...
/** Creates a new Query instance with the options provided. */ function we(t, e, n, s, i, r, o, c) {
    return new de(t, e, n, s, i, r, o, c);
}

/** Creates a new Query for a query that matches all documents at `path` */ function _e(t) {
    return new de(t);
}
 ...
 */ function Te(t) {
    ...
    if (null === e.V) {
        ...
        t.isKeyField() || e.V.push(new ue(t)), e.V.push(new ue(ft.keyField(), "asc" /* ASCENDING */)); else {
            let t = !1;
 ...
 */ function Ie(t) {
    const e = q(t);
    if (!e.S) if ("F" /* First */ === e.limitType) e.S = Wt(e.path, e.collectionGroup, Te(e), e.filters, e.limit, e.startAt, e.endAt); else {
        ...
        e.S = Wt(e.path, e.collectionGroup, t, e.filters, e.limit, n, s);
    }
    return e.S;
}
...
function Re(t, e) {
    return Ht(Ie(t), Ie(e)) && t.limitType === e.limitType;
}
...
function be(t) {
    return `${Gt(Ie(t))}|lt:${t.limitType}`;
}

function Pe(t) {
    return `Query(target=${zt(Ie(t))}; limitType=${t.limitType})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !le(t.startAt, Te(t), e)) return !1;
        if (t.endAt && le(t.endAt, Te(t), e)) return !1;
        return !0;
    }
    /**
 ...
 */ function ke(t, e, n) {
    ...
    }(n, e) : t instanceof Me ? Le(t, e) : t instanceof Be ? Ue(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        const n = Oe(t, e), s = Ke(n) + Ke(t.C);
        return Ot(n) && Ot(t.C) ? Ce(s) : De(t.N, s);
    }(t, e);
}
 ...
 */ function $e(t, e, n) {
    ...
    // applications.
    return t instanceof Me ? Le(t, e) : t instanceof Be ? Ue(t, e) : n;
}
 ...
 */ function Oe(t, e) {
    return t instanceof qe ? Ot(n = e) || function(t) {
...
/** Transforms an array value via a union operation. */ class Me extends xe {
    constructor(t) {
...
function Le(t, e) {
    const n = je(e);
    for (const e of t.elements) n.some((t => St(t, e))) || n.push(e);
    return {
        arrayValue: {
            values: n
        }
...
/** Transforms an array value via a remove operation. */ class Be extends xe {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Ue(t, e) {
    let n = je(e);
    for (const e of t.elements) n = n.filter((t => !St(t, e)));
    return {
        arrayValue: {
            values: n
        }
...
function We(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Me && e instanceof Me || t instanceof Be && e instanceof Be ? nt(t.elements, e.elements, St) : t instanceof qe && e instanceof qe ? St(t.C, e.C) : t instanceof Fe && e instanceof Fe;
 ...
 */ function Ye(t, e, n) {
    t instanceof nn ? function(t, e, n) {
        ...
        // must have held.
        const s = t.value.clone(), i = on(t.fieldTransforms, e, n.transformResults);
        ...
        const s = on(t.fieldTransforms, e, n.transformResults), i = e.data;
 ...
 */ function Xe(t, e, n) {
    t instanceof nn ? function(t, e, n) {
        ...
        return;
        const s = t.value.clone(), i = cn(t.fieldTransforms, n, e);
        s.setAll(i), e.convertToFoundDocument(en(e), s).setHasLocalMutations();
    }
    /**
 ...
 *    ignored.
 */ (t, e, n) : t instanceof sn ? function(t, e, n) {
        if (!He(t.precondition, e)) return;
        const s = cn(t.fieldTransforms, n, e), i = e.data;
        i.setAll(rn(t)), i.setAll(s), e.convertToFoundDocument(en(e), i).setHasLocalMutations();
    }
    /**
 ...
 */ function Ze(t, e) {
    ...
    for (const s of t.fieldTransforms) {
        const t = e.data.field(s.field), i = Oe(s.transform, t || null);
...
function tn(t, e) {
    return t.type === e.type && (!!t.key.isEqual(e.key) && (!!t.precondition.isEqual(e.precondition) && (!!function(t, e) {
        return void 0 === t && void 0 === e || !(!t || !e) && nt(t, e, ((t, e) => We(t, e)));
 ...
 */ function cn(t, e, n) {
    ...
    for (const i of t) {
        ...
        s.set(i.field, ke(t, r, e));
    }
    return s;
}

/** A mutation that deletes the document at the given key. */ class an extends Je {
    constructor(t, e) {
 ...
 *     Code.UNKNOWN.
 */ (fn = ln || (ln = {}))[fn.OK = 0] = "OK", fn[fn.CANCELLED = 1] = "CANCELLED", 
...
class _n {
    ...
    insert(t, e) {
        return new _n(this.comparator, this.root.insert(t, e, this.comparator).copy(null, null, gn.BLACK, null, null));
    }
    // Returns a copy of the map, with the specified key removed.
    remove(t) {
        return new _n(this.comparator, this.root.remove(t, this.comparator).copy(null, null, gn.BLACK, null, null));
    }
    ...
    getIterator() {
        return new mn(this.root, null, this.comparator, !1);
    }
    getIteratorFrom(t) {
        return new mn(this.root, t, this.comparator, !1);
    }
    getReverseIterator() {
        return new mn(this.root, null, this.comparator, !0);
    }
    getReverseIteratorFrom(t) {
        return new mn(this.root, t, this.comparator, !0);
    }
}
...
class gn {
    constructor(t, e, n, s, i) {
        this.key = t, this.value = e, this.color = null != n ? n : gn.RED, this.left = null != s ? s : gn.EMPTY, 
        this.right = null != i ? i : gn.EMPTY, this.size = this.left.size + 1 + this.right.size;
    }
    // Returns a copy of the current node, optionally replacing pieces of it.
    copy(t, e, n, s, i) {
        return new gn(null != t ? t : this.key, null != e ? e : this.value, null != n ? n : this.color, null != s ? s : this.left, null != i ? i : this.right);
    }
    isEmpty() {
        return !1;
    }
    ...
    removeMin() {
        if (this.left.isEmpty()) return gn.EMPTY;
        let t = this;
    ...
    remove(t, e) {
        ...
        s = s.copy(null, null, null, s.left.remove(t, e), null); else {
            ...
            0 === e(t, s.key)) {
                if (s.right.isEmpty()) return gn.EMPTY;
    ...
    rotateLeft() {
        const t = this.copy(null, null, gn.RED, null, this.right.left);
        return this.right.copy(null, null, this.color, t, null);
    }
    rotateRight() {
        const t = this.copy(null, null, gn.RED, this.left.right, null);
...
class yn {
    constructor(t) {
        this.comparator = t, this.data = new _n(this.comparator);
    }
    has(t) {
    ...
    getIterator() {
        return new pn(this.data.getIterator());
    }
    getIteratorFrom(t) {
        return new pn(this.data.getIteratorFrom(t));
    }
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const En = new _n(vt.comparator);

function Tn() {
    return En;
}

const In = new _n(vt.comparator);

function An() {
    return In;
}

const Rn = new _n(vt.comparator);

function bn() {
    return Rn;
}

const Pn = new yn(vt.comparator);
 ...
 */ class Dn {
    ...
    static createSynthesizedRemoteEventForCurrentChange(t, e) {
        const n = new Map;
        return n.set(t, Cn.createSynthesizedTargetChangeForCurrentChange(t, e)), new Dn(rt.min(), n, Sn(), Tn(), vn());
    }
}
 ...
 */ class Cn {
     ...
     */    static createSynthesizedTargetChangeForCurrentChange(t, e) {
        return new Cn(mt.EMPTY_BYTE_STRING, e, vn(), vn(), vn());
    }
}
...
class On {
     ...
     */    ft(t) {
        ...
        if (s) {
            ...
            if (Jt(t)) if (0 === n) {
                ...
                this.ct(e, n, jt.newNoDocument(n, rt.min()));
            } else B(1 === n); else {
                this.wt(e) !== n && (
     ...
     */    _t(t) {
        ...
        this.et.forEach(((n, s) => {
            ...
            if (i) {
                if (n.current && Jt(i.target)) {
                    ...
                    null !== this.nt.get(e) || this.gt(s, e) || this.ct(s, e, jt.newNoDocument(e, t));
                }
                n.K && (e.set(s, n.W()), n.G());
            }
        }));
        ...
        const s = new Dn(t, e, this.it, this.nt, n);
        return this.nt = Tn(), this.st = Fn(), this.it = new yn(et), s;
    }
    /**
    ...
    ut(t) {
        let e = this.et.get(t);
        return e || (e = new $n, this.et.set(t, e)), e;
    }
    yt(t) {
        let e = this.st.get(t);
        return e || (e = new yn(et), this.st = this.st.insert(t, e)), e;
    }
    /**
...
function Yn(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? ht.emptyPath() : Zn(e);
}
...
function es(t, e, n) {
    const s = Hn(t, e.name), i = Qn(e.updateTime), r = new qt({
        mapValue: {
            fields: e.fields
        }
...
function ns(t, e) {
    return "found" in e ? function(t, e) {
        ...
        const n = Hn(t, e.found.name), s = Qn(e.found.updateTime), i = new qt({
            mapValue: {
        ...
        const n = Hn(t, e.missing), s = Qn(e.readTime);
...
function ss(t, e) {
    ...
    if ("targetChange" in e) {
        ...
        const s = function(t) {
            ...
            return t.D ? (B(void 0 === e || "string" == typeof e), mt.fromBase64String(e || "")) : (B(void 0 === e || e instanceof Uint8Array), 
            mt.fromUint8Array(e || new Uint8Array));
        }(t, e.targetChange.resumeToken), o = e.targetChange.cause, c = o && function(t) {
            const e = void 0 === t.code ? K.UNKNOWN : wn(t.code);
 ...
 */ (o);
        ...
        const i = Hn(t, s.document.name), r = Qn(s.document.updateTime), o = new qt({
            mapValue: {
                fields: s.document.fields
            }
        }), c = jt.newFoundDocument(i, r, o), a = s.targetIds || [], u = s.removedTargetIds || [];
        n = new Nn(a, u, c.key, c);
    } else if ("documentDelete" in e) {
        e.documentDelete;
        const s = e.documentDelete;
        s.document;
        const i = Hn(t, s.document), r = s.readTime ? Qn(s.readTime) : rt.min(), o = jt.newNoDocument(i, r), c = s.removedTargetIds || [];
        n = new Nn([], c, o.key, o);
    } else if ("documentRemove" in e) {
        e.documentRemove;
        const s = e.documentRemove;
        s.document;
        const i = Hn(t, s.document), r = s.removedTargetIds || [];
        n = new Nn([], r, i, null);
    } else {
...
function rs(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? ze.updateTime(Qn(t.updateTime)) : void 0 !== t.exists ? ze.exists(t.exists) : ze.none();
    }(e.currentDocument) : ze.none(), s = e.updateTransforms ? e.updateTransforms.map((e => function(t, e) {
        let n = null;
        if ("setToServerValue" in e) B("REQUEST_TIME" === e.setToServerValue), n = new Fe; else if ("appendMissingElements" in e) {
            const t = e.appendMissingElements.values || [];
            n = new Me(t);
        } else if ("removeAllFromArray" in e) {
            const t = e.removeAllFromArray.values || [];
            n = new Be(t);
        } else "increment" in e ? n = new qe(t, e.increment) : L();
        const s = ft.fromServerFormat(e.fieldPath);
        return new Qe(s, n);
    }(t, e))) : [];
    if (e.update) {
        e.update.name;
        const i = Hn(t, e.update.name), r = new qt({
            mapValue: {
    ...
    if (e.delete) {
        const s = Hn(t, e.delete);
        return new an(s, n);
    }
    if (e.verify) {
        const s = Hn(t, e.verify);
        return new un(s, n);
    }
    return L();
}
...
function os(t, e) {
    return t && t.length > 0 ? (B(void 0 !== e), t.map((t => function(t, e) {
        ...
        n = Qn(e)), new Ge(n, t.transformResults || []);
    }(t, e)))) : [];
}
...
function as(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = Jn(t, s), n.structuredQuery.from = [ {
        ...
        allDescendants: !0
    } ]) : (n.parent = Jn(t, s.popLast()), n.structuredQuery.from = [ {
...
function us(t) {
    ...
    let u = null;
    return n.endAt && (u = ds(n.endAt)), we(e, i, o, r, c, "F" /* First */ , a, u);
}
...
function ls(t) {
    return t ? void 0 !== t.unaryFilter ? [ ps(t) ] : void 0 !== t.fieldFilter ? [ ys(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((t => ls(t))).reduce(((t, e) => t.concat(e))) : L() : [];
}
...
function ys(t) {
    return Yt.create(gs(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function ps(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        const e = gs(t.unaryFilter.field);
        return Yt.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = gs(t.unaryFilter.field);
        return Yt.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        const s = gs(t.unaryFilter.field);
        return Yt.create(s, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        const i = gs(t.unaryFilter.field);
...
function Is(t) {
    let e = "";
    for (let n = 0; n < t.length; n++) e.length > 0 && (e = Rs(e)), e = As(t.get(n), e);
    return Rs(e);
}
 ...
 */
xs.readTimeIndex = "readTimeIndex", xs.readTimeIndexPath = "readTime", 
/**
 ...
 */
xs.collectionReadTimeIndex = "collectionReadTimeIndex", xs.collectionReadTimeIndexPath = [ "parentPath", "readTime" ];
...
$s.queryTargetsIndexName = "queryTargetsIndex", 
/**
 * The index of all canonicalIds to the targets that they match. This is not
 * a unique mapping because canonicalId does not promise a unique name for all
 * possible queries, so we append the targetId to make the mapping unique.
 */
$s.queryTargetsKeyPath = [ "canonicalId", "targetId" ];
...
/** Name of the IndexedDb object store.  */ Os.store = "targetDocuments", 
/** Keys are automatically assigned via the targetId, path properties. */
Os.keyPath = [ "targetId", "path" ], 
/** The index name for the reverse index. */
Os.documentTargetsIndex = "documentTargetsIndex", 
/** We also need to create the reverse index for these properties. */
Os.documentTargetsKeyPath = [ "path", "targetId" ];
...
/** Name of the IndexedDb object store. */ Ls.store = "clientMetadata", 
...
/** Name of the IndexedDb object store. */ Us.store = "namedQueries", Us.keyPath = "name";

// Visible for testing
const qs = [ ...[ ...[ ...[ ...[ Vs.store, Ss.store, Ds.store, xs.store, $s.store, vs.store, Fs.store, Os.store ], Ls.store ], ks.store ], Ms.store ], Bs.store, Us.store ], Ks = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Qs {
    ...
    next(t, e) {
        return this.callbackAttached && L(), this.callbackAttached = !0, this.isDone ? this.error ? this.wrapFailure(e, this.error) : this.wrapSuccess(t, this.result) : new Qs(((n, s) => {
            this.nextCallback = e => {
...
class Ws {
    constructor(t, e) {
         ...
         */
        this.Tt = new Q, this.transaction.oncomplete = () => {
            this.Tt.resolve();
        }, this.transaction.onabort = () => {
            e.error ? this.Tt.reject(new Hs(t, e.error)) : this.Tt.resolve();
        }, this.transaction.onerror = e => {
            const n = ti(e.target.error);
            this.Tt.reject(new Hs(t, n));
        };
    }
    static open(t, e, n, s) {
        try {
            return new Ws(e, t.transaction(s, n));
        } catch (t) {
            throw new Hs(e, t);
        }
    }
    ...
    abort(t) {
        t && this.Tt.reject(t), this.aborted || ($("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class Gs {
    ...
    constructor(t, e, n) {
        ...
        // log on 12.2.
        12.2 === Gs.Rt(u()) && O("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /** Deletes the specified database. */    static delete(t) {
        return $("SimpleDb", "Removing database:", t), Xs(window.indexedDB.deleteDatabase(t)).toPromise();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static bt() {
        ...
        // Check the UA string to find out the browser.
                const t = u(), e = Gs.Rt(t), n = 0 < e && e < 10, s = Gs.vt(t), i = 0 < s && s < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, n, s) {
        ...
        for (;;) {
            ...
            try {
                ...
                const e = Ws.open(this.db, t, i ? "readonly" : "readwrite", n), r = s(e).catch((t => (
 ...
 */ class zs {
     ...
     */    delete() {
        return Xs(this.kt.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class Hs extends j {
    constructor(t, e) {
 ...
 */ class si {
    ...
    isEqual(t) {
        return this.batchId === t.batchId && nt(this.mutations, t.mutations, ((t, e) => tn(t, e))) && nt(this.baseMutations, t.baseMutations, ((t, e) => tn(t, e)));
    }
}
 ...
 */ class ri {
    ...
    /** Creates a new target data instance with an updated sequence number. */    withSequenceNumber(t) {
        return new ri(this.target, this.targetId, this.purpose, t, this.snapshotVersion, this.lastLimboFreeSnapshotVersion, this.resumeToken);
    }
    /**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */    withResumeToken(t, e) {
        return new ri(this.target, this.targetId, this.purpose, this.sequenceNumber, e, this.lastLimboFreeSnapshotVersion, t);
    }
    /**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */    withLastLimboFreeSnapshotVersion(t) {
        return new ri(this.target, this.targetId, this.purpose, this.sequenceNumber, this.snapshotVersion, t, this.resumeToken);
    }
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ class oi {
    constructor(t) {
        this.Wt = t;
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function ci(t, e) {
    if (e.document) return es(t.Wt, e.document, !!e.hasCommittedMutations);
    if (e.noDocument) {
        const t = vt.fromSegments(e.noDocument.path), n = fi(e.noDocument.readTime), s = jt.newNoDocument(t, n);
        return e.hasCommittedMutations ? s.setHasCommittedMutations() : s;
    }
    if (e.unknownDocument) {
        const t = vt.fromSegments(e.unknownDocument.path), n = fi(e.unknownDocument.version);
        return jt.newUnknownDocument(t, n);
    }
    return L();
}

/** Encodes a document for storage locally. */ function ai(t, e, n) {
    const s = ui(n), i = e.key.path.popLast().toArray();
    ...
    if (e.isNoDocument()) {
        const t = e.key.path.toArray(), n = li(e.version), r = e.hasCommittedMutations;
        return new xs(
        /* unknownDocument= */ null, new Cs(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e.isUnknownDocument()) {
        const t = e.key.path.toArray(), n = li(e.version);
        return new xs(new Ns(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function di(t, e) {
    const n = (e.baseMutations || []).map((e => rs(t.Wt, e)));
    ...
    const s = e.mutations.map((e => rs(t.Wt, e))), i = it.fromMillis(e.localWriteTimeMs);
    return new si(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function wi(t) {
    const e = fi(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? fi(t.lastLimboFreeSnapshotVersion) : rt.min();
    let s;
    var i;
    return void 0 !== t.query.documents ? (B(1 === (i = t.query).documents.length), 
    s = Ie(_e(Yn(i.documents[0])))) : s = function(t) {
        return Ie(us(t));
    }(t.query), new ri(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, mt.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function _i(t, e) {
    const n = li(e.snapshotVersion), s = li(e.lastLimboFreeSnapshotVersion);
    let i;
    i = Jt(e.target) ? cs(t.Wt, e.target) : as(t.Wt, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new $s(e.targetId, Gt(e.target), n, r, e.sequenceNumber, s, i);
}
 ...
 */ class Ti {
    ...
    add(t) {
        const e = t.lastSegment(), n = t.popLast(), s = this.index[e] || new yn(ht.comparator), i = !s.has(n);
    ...
    getEntries(t) {
        return (this.index[t] || new yn(ht.comparator)).toArray();
    }
}
...
class bi {
    ...
    static withCacheSize(t) {
        return new bi(t, bi.DEFAULT_COLLECTION_PERCENTILE, bi.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT);
    }
}
 ...
 */
function Pi(t, e, n) {
    const s = t.store(Ss.store), i = t.store(Ds.store), r = [], o = IDBKeyRange.only(n.batchId);
    let c = 0;
    const a = s.Kt({
        range: o
    }, ((t, e, n) => (c++, n.delete())));
    ...
    for (const t of n.mutations) {
        const s = Ds.key(e, t.key.path, n.batchId);
...
class Vi {
    ...
    addMutationBatch(t, e, n, s) {
        ...
        return r.add({}).next((o => {
            ...
            const c = new si(o, e, n, s), a = function(t, e, n) {
                const s = n.baseMutations.map((e => is(t.Wt, e))), i = n.mutations.map((e => is(t.Wt, e)));
                return new Ss(e, n.batchId, n.localWriteTime.toMillis(), s, i);
            }(this.N, this.userId, c), u = [];
            let h = new yn(((t, e) => et(t.canonicalString(), e.canonicalString())));
            for (const t of s) {
                const e = Ds.key(this.userId, t.key.path, o);
                h = h.add(t.key.path.popLast()), u.push(r.put(a)), u.push(i.put(e, Ds.PLACEHOLDER));
            }
            return h.forEach((e => {
    ...
    lookupMutationBatch(t, e) {
        return Di(t).get(e).next((t => t ? (B(t.userId === this.userId), di(this.N, t)) : null));
    }
    /**
    ...
    getNextMutationBatchAfterBatchId(t, e) {
        ...
        return Di(t).Kt({
            ...
            e.userId === this.userId && (B(e.batchId >= n), i = di(this.N, e)), s.done();
        })).next((() => i));
    }
    ...
    getAllMutationBatches(t) {
        ...
        return Di(t).Lt(Ss.userMutationsIndex, e).next((t => t.map((t => di(this.N, t)))));
    }
    getAllMutationBatchesAffectingDocumentKey(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = Ds.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Ci(t).Kt({
            range: s
        }, ((n, s, r) => {
            const [o, c, a] = n, u = bs(c);
            ...
            return Di(t).get(a).next((t => {
                if (!t) throw L();
                B(t.userId === this.userId), i.push(di(this.N, t));
            }));
            r.done();
        })).next((() => i));
    }
    getAllMutationBatchesAffectingDocumentKeys(t, e) {
        ...
        const s = [];
        return e.forEach((e => {
            const i = Ds.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Ci(t).Kt({
                range: r
            }, ((t, s, i) => {
                const [r, o, c] = t, a = bs(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
    ...
    getAllMutationBatchesAffectingQuery(t, e) {
        const n = e.path, s = n.length + 1, i = Ds.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    Zt(t, e) {
        ...
        return e.forEach((e => {
            s.push(Di(t).get(e).next((t => {
                if (null === t) throw L();
                B(t.userId === this.userId), n.push(di(this.N, t));
            })));
        })), Qs.waitFor(s).next((() => n));
    }
    removeMutationBatch(t, e) {
        return Pi(t.Qt, this.userId, e).next((n => (t.addOnCommittedListener((() => {
            this.te(e.batchId);
    ...
    performConsistencyCheck(t) {
        return this.checkEmpty(t).next((e => {
            ...
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(Ds.prefixForUser(this.userId)), s = [];
            return Ci(t).Kt({
                range: n
            }, ((t, e, n) => {
                if (t[0] === this.userId) {
    ...
    ee(t) {
        return Ni(t).get(this.userId).next((t => t || new Vs(this.userId, -1, 
        /*lastStreamToken=*/ "")));
    }
}
 ...
 */ function Si(t, e, n) {
    const s = Ds.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Ci(t).Kt({
        range: r,
        qt: !0
 ...
 */
function Di(t) {
    return ni(t, Ss.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ci(t) {
    return ni(t, Ds.store);
}

/**
 * Helper to get a typed SimpleDbStore for the mutationQueues object store.
 */ function Ni(t) {
    return ni(t, Vs.store);
}
 ...
 */ class ki {
    ...
    removeTargetData(t, e) {
        return this.removeMatchingKeysForTargetId(t, e.targetId).next((() => $i(t).delete(e.targetId))).next((() => this.re(t))).next((e => (B(e.targetCount > 0), 
    ...
    re(t) {
        return Oi(t).get(Fs.key).next((t => (B(null !== t), t)));
    }
    oe(t, e) {
        return Oi(t).put(Fs.key, e);
    }
    ce(t, e) {
        return $i(t).put(_i(this.N, e));
    }
    /**
    ...
    addMatchingKeys(t, e, n) {
        ...
        return e.forEach((e => {
            const r = Is(e.path);
            s.push(i.put(new Os(n, r))), s.push(this.referenceDelegate.addReference(t, n, e));
        })), Qs.waitFor(s);
    }
    ...
    getMatchingKeysForTargetId(t, e) {
        ...
        return s.Kt({
            ...
            const s = bs(t[1]), r = new vt(s);
            i = i.add(r);
        })).next((() => i));
    }
    containsKey(t, e) {
        const n = Is(e.path), s = IDBKeyRange.bound([ n ], [ st(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return Fi(t).Kt({
            index: Os.documentTargetsIndex,
            qt: !0,
            range: s
        }, (([t, e], n, s) => {
    ...
    // PORTING NOTE: Multi-tab only.
    Et(t, e) {
        return $i(t).get(e).next((t => t ? wi(t) : null));
    }
}
 ...
 */ function Oi(t) {
    return ni(t, Fs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function Fi(t) {
    return ni(t, Os.store);
}
 ...
 */ async function Mi(t) {
    if (t.code !== K.FAILED_PRECONDITION || t.message !== Ks) throw t;
 ...
 */ class Bi {
    constructor(t) {
        this.ue = t, this.buffer = new yn(Li), this.he = 0;
    }
    le() {
        return ++this.he;
    }
    fe(t) {
        ...
        if (this.buffer.size < this.ue) this.buffer = this.buffer.add(e); else {
            ...
            Li(e, t) < 0 && (this.buffer = this.buffer.delete(t).add(e));
        }
    }
    get maxValue() {
    ...
    _e(t) {
        ...
        $("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.we = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , e, (async () => {
            ...
            try {
                ...
                Js(t) ? $("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await Mi(t);
            }
            await this._e(t);
        }));
    }
...
/** Implements the steps for LRU garbage collection. */ class qi {
    ...
    collect(t, e) {
        ...
        Qs.resolve(Ri)) : this.getCacheSize(t).next((n => n < this.params.cacheSizeCollectionThreshold ? ($("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} is lower than threshold ${this.params.cacheSizeCollectionThreshold}`), 
        Ri) : this.pe(t, e)));
    }
    getCacheSize(t) {
...
class Ki {
     ...
     */    Ie(t, e) {
        return function(t, e) {
            let n = !1;
            return Ni(t).jt((s => Si(t, s, e).next((t => (t && (n = !0), Qs.resolve(!t)))))).next((() => n));
        }(t, e);
    }
    removeOrphanedDocuments(t, e) {
        ...
        return this.Te(t, ((r, o) => {
            if (o <= e) {
                const e = this.Ie(t, r).next((e => {
                    ...
                    // removing them.
                    return i++, n.getEntry(t, r).next((() => (n.removeEntry(r), Fi(t).delete([ 0, Is(r.path) ]))));
                }));
                s.push(e);
            }
 ...
 */ class Gi {
    ...
    getEntry(t, e) {
        return Ji(t).get(Yi(e)).next((t => this.Re(e, t)));
    }
    /**
     ...
     */    ve(t, e) {
        let n = Tn(), s = new _n(vt.comparator);
        return this.Pe(t, e, ((t, e) => {
            const i = this.Re(t, e);
    ...
    getDocumentsMatchingQuery(t, e, n) {
        ...
        if (n.isEqual(rt.min())) {
            ...
            const t = e.path.toArray(), s = ui(n);
            r.range = IDBKeyRange.lowerBound([ t, s ], 
            /* open= */ !0), r.index = xs.collectionReadTimeIndex;
        }
        return Ji(t).Kt(r, ((t, n, r) => {
    ...
    getMetadata(t) {
        return Hi(t).get(ks.key).next((t => (B(!!t), t)));
    }
    Ae(t, e) {
        return Hi(t).put(ks.key, e);
    }
    /**
...
class zi extends Wi {
    ...
    applyChanges(t) {
        const e = [];
        let n = 0, s = new yn(((t, e) => et(t.canonicalString(), e.canonicalString())));
        return this.changes.forEach(((i, r) => {
            const o = this.De.get(i);
            if (r.document.isValidDocument()) {
                const c = ai(this.Se.N, r.document, this.getReadTime(i));
                ...
                const n = ai(this.Se.N, jt.newNoDocument(i, rt.min()), this.getReadTime(i));
...
/** Performs database creation and schema upgrades. */ class Xi {
     ...
     */    Ct(t, e, n, s) {
        B(n < s && n >= 0 && s <= 11);
        const i = new Ws("createOrUpgrade", e);
        n < 1 && s >= 1 && (function(t) {
 ...
 */ (t), Zi(t), function(t) {
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(Os.store), t.deleteObjectStore($s.store), t.deleteObjectStore(Fs.store);
        }(t), Zi(t)), r = r.next((() => 
        /**
 ...
 */ (i)))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next((() => function(t, e) {
            return e.store(Ss.store).Lt().next((n => {
        ...
        n < 9 && s >= 9 && (r = r.next((() => {
            ...
            !function(t) {
                ...
                const e = t.objectStore(xs.store);
                e.createIndex(xs.readTimeIndex, xs.readTimeIndexPath, {
                    unique: !1
                }), e.createIndex(xs.collectionReadTimeIndex, xs.collectionReadTimeIndexPath, {
                    unique: !1
                });
            }(e);
 ...
 */ (t);
    ...
    Ne(t) {
        let e = 0;
        return t.store(xs.store).Kt(((t, n) => {
            e += vi(n);
        })).next((() => {
            const n = new ks(e);
            return t.store(ks.store).put(ks.key, n);
        }));
    }
    Ce(t) {
        const e = t.store(Vs.store), n = t.store(Ss.store);
        return e.Lt().next((e => Qs.forEach(e, (e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Lt(Ss.userMutationsIndex, s).next((n => Qs.forEach(n, (n => {
                B(n.userId === e.userId);
                const s = di(this.N, n);
     ...
     */    xe(t) {
        const e = t.store(Os.store), n = t.store(xs.store);
        return t.store(Fs.store).get(Fs.key).next((t => {
            ...
            return n.Kt(((n, i) => {
                ...
                s.push(e.get(o).next((n => n ? Qs.resolve() : (n => e.put(new Os(0, Is(n), t.highestListenSequenceNumber)))(r))));
            })).next((() => Qs.waitFor(s)));
        }));
    }
    ke(t, e) {
        ...
        return e.store(xs.store).Kt({
            qt: !0
        }, ((t, e) => {
            const n = new ht(t);
            return i(n.popLast());
        })).next((() => e.store(Ds.store).Kt({
            qt: !0
        }, (([t, e, n], s) => {
            const r = bs(e);
            return i(r.popLast());
    ...
    $e(t) {
        const e = t.store($s.store);
        return e.Kt(((t, n) => {
            const s = wi(n), i = _i(this.N, s);
            return e.put(i);
        }));
    }
}
...
function Zi(t) {
    t.createObjectStore(Os.store, {
        keyPath: Os.keyPath
    }).createIndex(Os.documentTargetsIndex, Os.documentTargetsKeyPath, {
        unique: !0
    });
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore($s.store, {
        keyPath: $s.keyPath
    }).createIndex($s.queryTargetsIndexName, $s.queryTargetsKeyPath, {
        unique: !0
...
class er {
    ...
    u) {
        ...
        this.Qe = t => Promise.resolve(), !er.bt()) throw new j(K.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.referenceDelegate = new Ki(this, s), this.We = e + "main", this.N = new oi(c), 
        this.Ge = new Gs(this.We, 11, new Xi(this.N)), this.ze = new ki(this.referenceDelegate, this.N), 
        this.Ht = new Ii, this.He = function(t, e) {
            return new Gi(t, e);
        }
        /**
 ...
 */
        ...
        (this.N, this.Ht), this.Je = new gi, this.window && this.window.localStorage ? this.Ye = this.window.localStorage : (this.Ye = null, 
     ...
     */    start() {
        ...
        return this.Xe().then((() => {
            ...
            throw new j(K.FAILED_PRECONDITION, tr);
     ...
     * primary lease.
     */    Xe() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (t => sr(t).put(new Ls(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next((() => {
    ...
    sn(t) {
        return nr(t).get(vs.key).next((t => Qs.resolve(this.an(t))));
    }
    un(t) {
     ...
     */    rn(t) {
        ...
        return nr(t).get(vs.key).next((e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || sr(t).Lt().next((t => void 0 === this.fn(t, 5e3).find((t => {
    ...
    async shutdown() {
        ...
        await this.Ge.runTransaction("shutdown", "readwrite", [ vs.store, Ls.store ], (t => {
            const e = new ei(t, X.T);
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    pn() {
        return this.runTransaction("getActiveClients", "readonly", (t => sr(t).Lt().next((t => this.fn(t, 18e5).map((t => t.clientId))))));
    }
    get started() {
        return this.Be;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.Ge.runTransaction(t, s, qs, (s => (i = new ei(s, this.Le ? this.Le.next() : X.T), 
        "readwrite-primary" === e ? this.sn(i).next((t => !!t || this.rn(i))).next((e => {
            ...
            this.Oe.enqueueRetryable((() => this.Qe(!1))), new j(K.FAILED_PRECONDITION, Ks);
            return n(i);
    ...
    // be turned off.
    En(t) {
        return nr(t).get(vs.key).next((t => {
            if (null !== t && this.ln(t.leaseTimestampMs, 5e3) && !this.wn(t.ownerId) && !this.an(t) && !(this.Me || this.allowTabSynchronization && t.allowTabSynchronization)) throw new j(K.FAILED_PRECONDITION, tr);
        }));
    }
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */    on(t) {
        const e = nr(t);
        return e.get(vs.key).next((t => this.an(t) ? ($("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(vs.key)) : Qs.resolve()));
    }
    ...
    Dn(t, e, n) {
        ...
        this.Cn(t, i, s).next((t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                ...
                i = jt.newInvalidDocument(n), s = s.insert(n, i)), Xe(e, i, t.localWriteTime), i.isFoundDocument() || (s = s.remove(n));
            }
        }))))).next((() => (
 ...
 */ class cr {
 ...
 // do nothing
        ...
        return new cr(t, e.fromCache, n, s);
    }
}
 ...
 */ class ar {
    ...
    /** Returns all local documents matching the specified query. */    getDocumentsMatchingQuery(t, e, n, s) {
        ...
        return function(t) {
            ...
            const r = this.Mn(e, i);
            return (me(e) || ge(e)) && this.Ln(e.limitType, r, s, n) ? this.Fn(t, e) : (x() <= c.DEBUG && $("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Pe(e)), 
    ...
    Fn(t, e) {
        return x() <= c.DEBUG && $("QueryEngine", "Using full collection scan to execute query:", Pe(e)), 
...
class ur {
    ...
    t, e, n, s) {
        ...
        this.ze = t.getTargetCache(), this.Qn = new or(this.jn, this.In, this.persistence.getIndexManager()), 
...
async function lr(t, e) {
    ...
    const r = await n.persistence.runTransaction("Handle user change", "readonly", (t => {
        ...
        // MutationQueue.
        i = new or(n.jn, s, n.persistence.getIndexManager()), s.getAllMutationBatches(t)))).next((e => {
            const n = [], s = [];
 ...
 */ (c, u, e) && o.push(n.ze.updateTargetData(t, u));
        ...
        o.push(_r(t, r, e.documentUpdates, s, void 0).next((t => {
            c = t;
        }))), !s.isEqual(rt.min())) {
            const e = n.ze.getLastRemoteSnapshotVersion(t).next((e => n.ze.setTargetsMetadata(t, t.currentSequenceNumber, s)));
            o.push(e);
        }
        return Qs.waitFor(o).next((() => r.apply(t))).next((() => n.Qn.vn(t, c))).next((() => c));
    })).then((t => (n.Un = i, t)));
}
...
function gr(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (t => {
        ...
        s = i, Qs.resolve(s)) : n.ze.allocateTargetId(t).next((i => (s = new ri(e, i, 0 /* Listen */ , t.currentSequenceNumber), 
 ...
 */ function pr(t, e, n) {
    ...
    })).next((() => s.Bn.getDocumentsMatchingQuery(t, e, n ? i : rt.min(), n ? r : vn()))).next((t => ({
        documents: t,
        Gn: r
    })))));
}
...
async function Ir(t) {
    ...
    return e.persistence.runTransaction("Synchronize last document change read time", "readonly", (t => function(t) {
        ...
        return e.Kt({
            ...
            e.readTime && (n = hi(e.readTime)), s.done();
        })).next((() => n));
    }(t))).then((t => {
        e.Kn = t;
    }));
...
async function Ar(t, e, n, s) {
    ...
    const a = i.jn.newChangeBuffer({
        trackRemovals: !0
    }), u = await gr(i, function(t) {
        // It is OK that the path used for the query is not valid, because this will
        // not be read and queried.
        return Ie(_e(ht.fromString(`__bundle__/docs/${t}`)));
    }(s));
    // Allocates a target to hold all document keys from the bundle, such that
    // they will not get garbage collected right away.
        return i.persistence.runTransaction("Apply bundle documents", "readwrite", (t => _r(t, a, o, rt.min(), c).next((e => (a.apply(t), 
 ...
 */
async function Rr(t, e, n = vn()) {
    // Allocate a target for the named query such that it can be resumed
    // from associated read time if users use it to listen.
    // NOTE: this also means if no corresponding target exists, the new target
    // will remain active and will not get collected, unless users happen to
    // unlisten the query somehow.
    const s = await gr(t, Ie(mi(e.bundledQuery))), i = q(t);
    return i.persistence.runTransaction("Save named query", "readwrite", (t => {
        ...
        // Update existing target data because the query from the bundle is newer.
                const o = s.withResumeToken(mt.EMPTY_BYTE_STRING, r);
 ...
 */ class Pr {
    constructor() {
        ...
        this.Zn = new yn(vr.ts), 
        // A set of outstanding references to a document sorted by target id.
        this.es = new yn(vr.ns);
    }
     ...
     * removed.
     */    cs(t) {
        const e = new vt(new ht([])), n = new vr(e, t), s = new vr(e, t + 1), i = [];
    ...
    hs(t) {
        const e = new vt(new ht([])), n = new vr(e, t), s = new vr(e, t + 1);
        let i = vn();
        return this.es.forEachInRange([ n, s ], (t => {
            i = i.add(t.key);
        })), i;
...
class vr {
    ...
    /** Compare by key then by ID */    static ts(t, e) {
        return vt.comparator(t.key, e.key) || et(t.ls, e.ls);
    }
    /** Compare by ID then by key */    static ns(t, e) {
        return et(t.ls, e.ls) || vt.comparator(t.key, e.key);
    }
}
...
class Sr {
    ...
    constructor(t, e) {
        ...
        this.docs = new _n(vt.comparator), 
    ...
    getEntry(t, e) {
        ...
        return Qs.resolve(n ? n.document.clone() : jt.newInvalidDocument(e));
    }
    getEntries(t, e) {
        let n = Tn();
        return e.forEach((t => {
            const e = this.docs.get(t);
            n = n.insert(t, e ? e.document.clone() : jt.newInvalidDocument(t));
        })), Qs.resolve(n);
    }
    getDocumentsMatchingQuery(t, e, n) {
        let s = Tn();
 ...
 */ class Cr {
    constructor(t) {
         ...
         * IDs.
         */
        this.As = new Pr, this.targetCount = 0, this.Rs = xi.se();
    }
    forEachTarget(t, e) {
    ...
    ce(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.Rs = new xi(e), this.highestTargetId = e), t.sequenceNumber > this.Is && (this.Is = t.sequenceNumber);
    }
    addTargetData(t, e) {
        return this.ce(e), this.targetCount += 1, Qs.resolve();
    }
    updateTargetData(t, e) {
        return this.ce(e), Qs.resolve();
    }
    removeTargetData(t, e) {
...
class Nr {
    ...
    constructor(t, e) {
        ...
        this.Ht = new Ei, this.He = function(t, e) {
            return new Sr(t, e);
        }(this.Ht, (t => this.referenceDelegate.Ps(t))), this.N = new oi(e), this.Je = new br(this.N);
    }
    start() {
...
class Mr {
     ...
     */    static $s(t, e, n) {
        ...
        r && (i = new j(s.error.code, s.error.message))), r ? new Mr(t, e, s.state, i) : (O("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Os() {
        const t = {
...
class Lr {
     ...
     */    static $s(t, e) {
        ...
        i && (s = new j(n.error.code, n.error.message))), i ? new Lr(t, n.state, s) : (O("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Os() {
        const t = {
 ...
 */ class Br {
     ...
     */    static $s(t, e) {
        ...
        for (let t = 0; s && t < n.activeTargetIds.length; ++t) s = Pt(n.activeTargetIds[t]), 
        i = i.add(n.activeTargetIds[t]);
        return s ? new Br(t, i) : (O("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Ur {
     ...
     */    static $s(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Ur(e.clientId, e.onlineState) : (O("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Kr {
    constructor(t, e, n, s, i) {
        ...
        this.qs = new _n(et), this.started = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.js = $r(this.persistenceKey, this.Ls), 
        this.Qs = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.qs = this.qs.insert(this.Ls, new qr), this.Ws = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
 ...
 */ (e.newValue);
    ...
    ii(t, e, n) {
        const s = Fr(this.persistenceKey, t), i = new Lr(t, e, n);
        this.setItem(s, i.Os());
    }
    oi() {
...
class jr {
    constructor() {
        this.yi = new qr, this.pi = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    addPendingMutation(t) {
        // No op.
    }
    ...
    start() {
        return this.yi = new qr, Promise.resolve();
    }
    handleUserChange(t, e, n) {
        // No op.
    }
 ...
 */
            ...
            t.stat === S.PROXY ? $("Connection", "Detected buffering proxy") : t.stat === S.NOPROXY && $("Connection", "Detected no buffering proxy");
        })), setTimeout((() => {
...
class to {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.sr = 0, this.ir = null, this.stream = null, this.rr = new Zr(t, e);
    }
    /**
 ...
 */ class eo extends to {
    ...
    onMessage(t) {
        ...
        this.rr.reset();
        const e = ss(this.N, t), n = function(t) {
            // We have only reached a consistent snapshot for the entire stream if there
            // is a read_time set and it applies to all targets (i.e. the list of
            // targets is empty). The backend is guaranteed to send such responses.
            if (!("targetChange" in t)) return rt.min();
            const e = t.targetChange;
            return e.targetIds && e.targetIds.length ? rt.min() : e.readTime ? Qn(e.readTime) : rt.min();
        }(t);
     ...
     */    Ir(t) {
        ...
        e.database = Xn(this.N), e.addTarget = function(t, e) {
            ...
            return n = Jt(s) ? {
                ...
                query: as(t, s)
            }, n.targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = Kn(t, e.resumeToken) : e.snapshotVersion.compareTo(rt.min()) > 0 && (
 ...
 */ class no extends to {
    ...
    onMessage(t) {
        ...
        B(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Rr) {
            ...
            this.rr.reset();
            const e = os(t.writeResults, t.commitTime), n = Qn(t.commitTime);
    ...
    e, n, s, i) {
        ...
        this.jr = [], this.Qr = i, this.Qr.Ei((t => {
            n.enqueueAndForget((async () => {
                ...
                // down our streams.
                _o(this) && ($("RemoteStore", "Restarting streams for network reachability change."), 
                await async function(t) {
                    const e = q(t);
                    e.Kr.add(4 /* ConnectivityChange */), await co(e), e.Wr.set("Unknown" /* Unknown */), 
                    e.Kr.delete(4 /* ConnectivityChange */), await oo(e);
                }(this));
            }));
        })), this.Wr = new io(n, s);
    }
...
async function oo(t) {
    if (_o(t)) for (const e of t.jr) await e(/* enabled= */ !0);
}
 ...
 */ function uo(t, e) {
    const n = q(t), s = No(n);
    n.qr.delete(e), s.ar() && lo(n, e), 0 === n.qr.size && (s.ar() ? s.lr() : _o(n) && 
 ...
 */ function wo(t) {
    return _o(t) && !No(t).cr() && t.qr.size > 0;
}
...
async function po(t, e, n) {
    ...
    t.Wr.set("Online" /* Online */), e instanceof kn && 2 /* Removed */ === e.state && e.cause) 
 ...
 */ (t, e);
        ...
        await Eo(t, n);
    } else if (e instanceof Nn ? t.Gr.rt(e) : e instanceof xn ? t.Gr.ft(e) : t.Gr.at(e), 
    !n.isEqual(rt.min())) try {
        const e = await dr(t.localStore);
        n.compareTo(e) >= 0 && 
 ...
 */
        function(t, e) {
            ...
            n.targetMismatches.forEach((e => {
                ...
                const s = new ri(n.target, e, 1 /* ExistenceFilterMismatch */ , n.sequenceNumber);
                ho(t, s);
            })), t.remoteSyncer.applyRemoteEvent(n);
        }(t, n);
    } catch (e) {
        $("RemoteStore", "Failed to raise snapshot:", e), await Eo(t, e);
    }
}
 ...
 */ async function Eo(t, e, n) {
    ...
    await co(t), t.Wr.set("Offline" /* Offline */), n || (
...
async function Io(t) {
    ...
    for (;Ao(e); ) try {
        const t = await mr(e.localStore, s);
        if (null === t) {
            0 === e.Ur.length && n.lr();
            break;
        }
...
function bo(t) {
    return _o(t) && !xo(t).cr() && t.Ur.length > 0;
}
...
async function So(t, e, n) {
    const s = t.Ur.shift(), i = ii.from(s, e, n);
...
async function Do(t, e) {
    ...
    await async function(t, e) {
        ...
        if (n = e.code, dn(n) && n !== K.ABORTED) {
            ...
            // restart.
                        xo(t).hr(), await To(t, (() => t.remoteSyncer.rejectFailedWrite(n.batchId, e))), 
...
async function Co(t, e) {
    const n = q(t);
    e ? (n.Kr.delete(2 /* IsSecondary */), await oo(n)) : e || (n.Kr.add(2 /* IsSecondary */), 
    await co(n), n.Wr.set("Unknown" /* Unknown */));
}
 ...
 */ (t.datastore, t.asyncQueue, {
        ...
        e ? (t.zr.hr(), wo(t) ? fo(t) : t.Wr.set("Unknown" /* Unknown */)) : (await t.zr.stop(), 
        mo(t));
    }))), t.zr;
}
 ...
 */ function xo(t) {
    ...
    t.Hr = function(t, e, n) {
        const s = q(t);
        return s.Cr(), new no(e, s.nr, s.credentials, s.N, n);
    }(t.datastore, t.asyncQueue, {
        Si: vo.bind(null, t),
        Ci: Do.bind(null, t),
        Vr: Vo.bind(null, t),
        ...
        await Io(t)) : (await t.Hr.stop(), t.Ur.length > 0 && ($("RemoteStore", `Stopping write stream with ${t.Ur.length} pending writes`), 
        t.Ur = []));
    }))), t.Hr;
}
...
class ko {
     ...
     */    static createAndSchedule(t, e, n, s, i) {
        const r = Date.now() + n, o = new ko(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
 ...
 */ function $o(t, e) {
    if (O("AsyncQueue", `${e}: ${t}`), Js(t)) return new j(K.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Oo {
    ...
    constructor(t) {
        ...
        this.keyedMap = An(), this.sortedSet = new _n(this.comparator);
    }
    /**
     * Returns an empty copy of the existing DocumentSet, using the same
     * comparator.
     */    static emptySet(t) {
        return new Oo(t.comparator);
    }
    has(t) {
...
class Mo {
    ...
    /** Returns a view snapshot as if all documents in the snapshot were added. */    static fromInitialDocuments(t, e, n, s) {
        ...
        })), new Mo(t, e, Oo.emptySet(e), i, n, s, 
        /* syncStateChanged= */ !0, 
...
class Bo {
    constructor() {
        this.queries = new Qi((t => be(t)), Re), this.onlineState = "Unknown" /* Unknown */ , 
        this.Zr = new Set;
    }
}
...
async function Uo(t, e) {
    ...
    if (r || (i = !0, r = new Lo), i) try {
        r.Xr = await n.onListen(s);
    } catch (t) {
        const n = $o(t, `Initialization of query '${Pe(e.query)}' failed`);
 ...
 */ class Wo {
    ...
    ao(t) {
        t = Mo.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.io = !0, 
        this.so.next(t);
    }
}
 ...
 */ class zo {
     ...
     */    Hn(t) {
        return t.metadata.exists ? es(this.N, t.document, !1) : jt.newNoDocument(this.zn(t.metadata.name), this.Jn(t.metadata.readTime));
    }
    Jn(t) {
        return Qn(t);
    }
 ...
 */ class Ho {
    ...
    wo(t) {
        const e = new Map, n = new zo(this.N);
     ...
     */    async complete() {
        const t = await Ar(this.localStore, new zo(this.N), this.documents, this.lo.id), e = this.wo(this.documents);
        for (const t of this.queries) await Rr(this.localStore, t, e.get(t.name));
        return this.progress.taskState = "Success", new rr(Object.assign({}, this.progress), t);
    }
}
 ...
 */ class Zo {
    ...
    e) {
        ...
        this.mutatedKeys = vn(), this.po = Ve(t), this.Eo = new Oo(this.po);
    }
    /**
     ...
     */    Io(t, e) {
        const n = e ? e.Ao : new Fo, s = e ? e.Eo : this.Eo;
        ...
        const c = me(this.query) && s.size === this.query.limit ? s.last() : null, a = ge(this.query) && s.size === this.query.limit ? s.first() : null;
        ...
        })), me(this.query) || ge(this.query)) for (;r.size > this.query.limit; ) {
            const t = me(this.query) ? r.last() : r.first();
 ...
 */ (t.type, e.type) || this.po(t.doc, e.doc))), this.bo(n);
        ...
        if (this.mo = o, 0 !== i.length || c) {
            return {
                snapshot: new Mo(this.query, t.Eo, s, i, t.mutatedKeys, 0 /* Local */ === o, c, 
                /* excludesMetadataChanges= */ !1),
                vo: r
            };
        }
    ...
    Po() {
        ...
        // updating many documents.
                const t = this.yo;
        this.yo = vn(), this.Eo.forEach((t => {
            this.Vo(t.key) && (this.yo = this.yo.add(t.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach((t => {
            this.yo.has(t) || e.push(new Xo(t));
        })), this.yo.forEach((n => {
            t.has(n) || e.push(new Yo(n));
        })), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Do() {
        return Mo.fromInitialDocuments(this.query, this.Eo, this.mutatedKeys, 0 /* Local */ === this.mo);
    }
}
 ...
 */ class nc {
    ...
    s, i, r) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = r, this.No = {}, this.xo = new Qi((t => be(t)), Re), 
        this.ko = new Map, 
        /**
         ...
         * active target.
         */
        this.Oo = new _n(vt.comparator), 
        /**
         * Keeps track of the information about an active limbo resolution for each
         * active target ID that was started for the purpose of limbo resolution.
         */
        this.Fo = new Map, this.Mo = new Pr, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.Lo = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.Bo = new Map, this.Uo = xi.ie(), this.onlineState = "Unknown" /* Unknown */ , 
...
async function sc(t, e) {
    ...
    s = r.targetId, n.sharedClientState.addLocalQueryTarget(s), i = r.view.Do(); else {
        const t = await gr(n.localStore, Ie(e)), r = n.sharedClientState.addLocalQueryTarget(t.targetId);
        s = t.targetId, i = await ic(n, e, s, "current" === r), n.isPrimaryClient && ao(n.remoteStore, t);
    }
    return i;
}
 ...
 */ async function ic(t, e, n, s) {
    ...
    t.Ko = (e, n, s) => async function(t, e, n, s) {
        ...
        i = await pr(t.localStore, e.query, 
        /* usePreviousResults= */ !1).then((({documents: t}) => e.view.Io(t, i))));
        const r = s && s.targetChanges.get(e.targetId), o = e.view.applyChanges(i, 
        /* updateLimboDocuments= */ t.isPrimaryClient, r);
        return gc(t, e.targetId, o.vo), o.snapshot;
    }(t, e, n, s);
    const i = await pr(t.localStore, e, 
    /* usePreviousResults= */ !0), r = new Zo(e, i.Gn), o = r.Io(i.documents), c = Cn.createSynthesizedTargetChangeForCurrentChange(n, s && "Offline" /* Offline */ !== t.onlineState), a = r.applyChanges(o, 
    /* updateLimboDocuments= */ t.isPrimaryClient, c);
    gc(t, n, a.vo);
    const u = new tc(e, n, r);
...
/** Stops listening to the query. */ async function rc(t, e) {
    ...
    if (i.length > 1) return n.ko.set(s.targetId, i.filter((t => !Re(t, e)))), void n.xo.delete(e);
    // No other queries are mapped to the target, clean up the query and the target.
        if (n.isPrimaryClient) {
        // We need to remove the local query target first to allow us to verify
        // whether any other client is still interested in this target.
        n.sharedClientState.removeLocalQueryTarget(s.targetId);
        n.sharedClientState.isActiveQueryTarget(s.targetId) || await yr(n.localStore, s.targetId, 
        /*keepPersistedTargetData=*/ !1).then((() => {
            n.sharedClientState.clearQueryState(s.targetId), uo(n.remoteStore, s.targetId), 
            _c(n, s.targetId);
        })).catch(Mi);
    } else _c(n, s.targetId), await yr(n.localStore, s.targetId, 
 ...
 */ async function oc(t, e, n) {
    ...
    try {
        const t = await function(t, e) {
            const n = q(t), s = it.now(), i = e.reduce(((t, e) => t.add(e.key)), vn());
            let r;
            return n.persistence.runTransaction("Locally write mutations", "readwrite", (t => n.Qn.Pn(t, i).next((i => {
                ...
                for (const t of e) {
                    ...
                    // exists=true
                    o.push(new sn(t.key, e, Kt(e.value.mapValue), ze.exists(!0)));
                }
 ...
 * it.
 */ (s, t.batchId, n), await Ec(s, t.changes), await Io(s.remoteStore);
    } catch (t) {
        // If we can't persist the mutation, we reject the user callback and
        // don't send the mutation. The user can then retry the write.
        const e = $o(t, "Failed to persist write");
        n.reject(e);
    }
}
 ...
 */ async function uc(t, e, n) {
    ...
    if (r) {
        ...
        let t = new _n(vt.comparator);
        t = t.insert(r, jt.newNoDocument(r, rt.min()));
        const n = vn().add(r), i = new Dn(rt.min(), 
        /* targetChanges= */ new Map, 
        /* targetMismatches= */ new yn(et), t, n);
        await cc(s, i), 
        ...
        s.Oo = s.Oo.remove(r), s.Fo.delete(e), pc(s);
    } else await yr(s.localStore, e, 
    /* keepPersistedTargetData */ !1).then((() => _c(s, e, n))).catch(Mi);
}
...
async function hc(t, e) {
    ...
    try {
        ...
        // before listen events.
                wc(n, s, /*error=*/ null), dc(n, s), n.sharedClientState.updateMutationState(s, "acknowledged"), 
        await Ec(n, t);
    } catch (t) {
        await Mi(t);
    }
 ...
 */ (s.localStore, e);
        ...
        // listen events.
                wc(s, e, n), dc(s, e), s.sharedClientState.updateMutationState(e, "rejected", n), 
        await Ec(s, t);
    } catch (n) {
        await Mi(n);
    }
 ...
 */ async function fc(t, e) {
    const n = q(t);
    _o(n.remoteStore) || $("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
    try {
        ...
        const n = $o(t, "Initialization of waitForPendingWrites() operation failed");
        e.reject(n);
    }
}
...
/** Reject all outstanding callbacks waiting for pending writes to complete. */ function wc(t, e, n) {
    const s = q(t);
...
function mc(t, e) {
    ...
    const n = t.Oo.get(e);
    null !== n && (uo(t.remoteStore, n), t.Oo = t.Oo.remove(e), t.Fo.delete(n), pc(t));
}

function gc(t, e, n) {
    for (const s of n) if (s instanceof Yo) t.Mo.addReference(s.key, e), yc(t, s); else if (s instanceof Xo) {
 ...
 */ function pc(t) {
    for (;t.$o.size > 0 && t.Oo.size < t.maxConcurrentLimboResolutions; ) {
        ...
        t.$o.delete(e);
        const n = new vt(ht.fromString(e)), s = t.Uo.next();
        t.Fo.set(s, new ec(n)), t.Oo = t.Oo.insert(n, s), ao(t.remoteStore, new ri(Ie(_e(n.path)), s, 2 /* LimboResolution */ , X.T));
    }
}
 ...
 */ async function Ac(t, e) {
    const n = q(t), s = await pr(n.localStore, e.query, 
    /* usePreviousResults= */ !0), i = e.view.So(s);
    return n.isPrimaryClient && gc(n, e.targetId, i.vo), i;
}
...
async function Rc(t) {
    const e = q(t);
    return Tr(e.localStore).then((t => Ec(e, t)));
}
...
async function bc(t, e, n, s) {
    ...
    // other clients.
    wc(i, e, s || null), dc(i, e), function(t, e) {
        q(q(t).In).te(e);
    }
    // PORTING NOTE: Multi-Tab only.
    (i.localStore, e)) : L(), await Ec(i, r)) : 
...
async function Pc(t, e) {
    ...
    if (Nc(n), xc(n), !0 === e && !0 !== n.qo) {
        ...
        n.qo = !0, await Co(n.remoteStore, !0);
        for (const t of e) ao(n.remoteStore, t);
    } else if (!1 === e && !1 !== n.qo) {
        const t = [];
        let e = Promise.resolve();
        n.ko.forEach(((s, i) => {
            n.sharedClientState.isLocalQueryTarget(i) ? t.push(i) : e = e.then((() => (_c(n, i), 
            yr(n.localStore, i, 
        ...
        function(t) {
            ...
            e.Fo.forEach(((t, n) => {
                uo(e.remoteStore, n);
            })), e.Mo.us(), e.Fo = new Map, e.Oo = new _n(vt.comparator);
        }
        /**
 ...
 */
        // PORTING NOTE: Multi-Tab only.
        (n), n.qo = !1, await Co(n.remoteStore, !1);
    }
}
...
async function vc(t, e, n) {
    ...
    for (const t of e) {
        ...
        if (n && 0 !== n.length) {
            ...
            e = await gr(s.localStore, Ie(n[0]));
            for (const t of n) {
                const e = s.xo.get(t), n = await Ac(s, e);
            ...
            e = await gr(s.localStore, n), await ic(s, Vc(n), t, 
            /*current=*/ !1);
        }
        i.push(e);
    }
...
async function Dc(t, e, n, s) {
    ...
    $("SyncEngine", "Ignoring unexpected query state notification."); else if (i.ko.has(e)) switch (n) {
      ...
      case "not-current":
        {
            const t = await Tr(i.localStore), s = Dn.createSynthesizedRemoteEventForCurrentChange(e, "current" === n);
            await Ec(i, t, s);
            break;
        }

      case "rejected":
        await yr(i.localStore, e, 
        /* keepPersistedTargetData */ !0), _c(i, e, s);
        break;
...
/** Adds or removes Watch targets for queries from different tabs. */ async function Cc(t, e, n) {
    ...
    if (s.qo) {
        for (const t of e) {
            ...
            const e = await Er(s.localStore, t), n = await gr(s.localStore, e);
        ...
        await yr(s.localStore, t, 
        /* keepPersistedTargetData */ !1).then((() => {
            uo(s.remoteStore, t), _c(s, t);
        })).catch(Mi);
    }
}
...
function Nc(t) {
    const e = q(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = cc.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = Ic.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = uc.bind(null, e), e.No.Tr = Ko.bind(null, e.eventManager), 
    e.No.jo = jo.bind(null, e.eventManager), e;
}
 ...
 */ (t.localStore, s)) return await e.close(), void n._completeWith(function(t) {
            ...
            n._updateProgress(Jo(s));
            const i = new Ho(s, t.localStore, e.N);
            let r = await e.Qo();
            for (;r; ) {
...
class $c {
    ...
    async initialize(t) {
        this.N = Xr(t.databaseInfo.databaseId), this.sharedClientState = this.Wo(t), this.persistence = this.Go(t), 
    ...
    Ho(t) {
        return hr(this.persistence, new ar, t.initialUser, this.N);
    }
    Go(t) {
        return new Nr(kr.Ns, this.N);
    }
    Wo(t) {
        return new jr;
    }
 ...
 */ class Oc extends $c {
    ...
    async initialize(t) {
        await super.initialize(t), await Ir(this.localStore), await this.Jo.initialize(this, t), 
        // Enqueue writes from a previous session
        await xc(this.Jo.syncEngine), await Io(this.Jo.remoteStore), 
    ...
    Go(t) {
        const e = ir(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? bi.withCacheSize(this.cacheSizeBytes) : bi.DEFAULT;
        return new er(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Jr(), Yr(), this.N, this.sharedClientState, !!this.forceOwnership);
    }
    Wo(t) {
        return new jr;
    }
 ...
 */ class Fc extends Oc {
    ...
    async initialize(t) {
        ...
        await this.persistence.nn((async t => {
            await Pc(this.Jo.syncEngine, t), this.gcScheduler && (t && !this.gcScheduler.started ? this.gcScheduler.start(this.localStore) : t || this.gcScheduler.stop());
        }));
    }
    Wo(t) {
        const e = Jr();
        if (!Kr.bt(e)) throw new j(K.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        const n = ir(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
 ...
 */ class Mc {
    async initialize(t, e) {
        ...
        /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = t => ac(this.syncEngine, t, 1 /* SharedClientState */), 
    ...
    createDatastore(t) {
        const e = Xr(t.databaseInfo.databaseId), n = (s = t.databaseInfo, new Hr(s));
        var s;
    ...
    createRemoteStore(t) {
        return e = this.localStore, n = this.datastore, s = t.asyncQueue, i = t => ac(this.syncEngine, t, 0 /* RemoteStore */), 
        r = Wr.bt() ? new Wr : new Qr, new ro(e, n, s, i, r);
        var e, n, s, i, r;
    ...
    terminate() {
        return async function(t) {
            const e = q(t);
            $("RemoteStore", "RemoteStore shutting down."), e.Kr.add(5 /* Shutdown */), await co(e), 
            e.Qr.shutdown(), 
 ...
 */ class Uc {
     ...
     */    async ec() {
        ...
        return new Go(JSON.parse(s), t.length + n);
    }
...
class qc {
    ...
    async lookup(t) {
        ...
        const e = await async function(t, e) {
            const n = q(t), s = Xn(n.N) + "/documents", i = {
                documents: e.map((t => zn(n.N, t)))
    ...
    async commit() {
        ...
        t.forEach(((t, e) => {
            ...
            this.mutations.push(new un(n, this.precondition(n)));
        })), await async function(t, e) {
            const n = q(t), s = Xn(n.N) + "/documents", i = {
                writes: e.map((t => is(n.N, t)))
            };
...
class Kc {
    constructor(t, e, n, s) {
        ...
        this.cc = 5, this.rr = new Zr(this.asyncQueue, "transaction_retry" /* TransactionRetry */);
    }
    ...
    ac() {
        this.rr.Xi((async () => {
            const t = new qc(this.datastore), e = this.uc(t);
            e && e.then((e => {
    ...
    terminate() {
        ...
        return this.asyncQueue.enqueueAndForgetEvenWhileRestricted((async () => {
            try {
                ...
                const n = $o(e, "Failed to shutdown persistence");
                t.reject(n);
            }
        })), t.promise;
    }
...
async function Qc(t, e) {
    ...
    t.setCredentialChangeListener((async t => {
        s.isEqual(t) || (await lr(e.localStore, t), s = t);
    })), 
...
/** Enables the network connection and re-enqueues all pending operations. */ function ta(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!0), function(t) {
            const e = q(t);
            return e.Kr.delete(0 /* UserDisabled */), oo(e);
        }(n);
    }));
}
...
/** Disables the network connection. Pending operations will not complete. */ function ea(t) {
    return t.asyncQueue.enqueue((async () => {
        ...
        return e.setNetworkEnabled(!1), async function(t) {
            const e = q(t);
            e.Kr.add(0 /* UserDisabled */), await co(e), 
 ...
 */ function na(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            ...
            const s = $o(t, `Failed to get document '${e} from cache`);
            n.reject(s);
        }
    }
    /**
...
function ia(t, e) {
    ...
    return t.asyncQueue.enqueueAndForget((async () => async function(t, e, n) {
        try {
            const s = await pr(t, e, 
            /* usePreviousResults= */ !0), i = new Zo(e, s.Gn), r = i.Io(s.documents), o = i.applyChanges(r, 
            /* updateLimboDocuments= */ !1);
            n.resolve(o.snapshot);
        } catch (t) {
            const s = $o(t, `Failed to execute query '${e} against cache`);
            n.reject(s);
        }
    }
    /**
    ...
    return t.asyncQueue.enqueueAndForget((async () => function(t, e, n, s, i) {
        const r = new Bc({
            next: n => {
                // Remove query first before passing event to user to avoid
                // user actions affecting the now stale query.
                e.enqueueAndForget((() => qo(t, o))), n.fromCache && "server" === s.source ? i.reject(new j(K.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : i.resolve(n);
            },
            error: t => i.reject(t)
        }), o = new Wo(n, r, {
            includeMetadataChanges: !0,
...
function aa(t, e, n, s) {
    const i = function(t, e) {
        ...
        return function(t, e) {
            ...
            if (t instanceof Uint8Array) return Lc(t, e);
            if (t instanceof ArrayBuffer) return Lc(new Uint8Array(t), e);
...
class la {
    ...
    isEqual(t) {
        return t instanceof la && t.projectId === this.projectId && t.database === this.database;
    }
}
 ...
 */ function _a(t) {
    if (!vt.isDocumentKey(t)) throw new j(K.INVALID_ARGUMENT, `Invalid document reference. Document references must have an even number of segments, but ${t} has ${t.length}.`);
}
 ...
 */ function ma(t) {
    if (vt.isDocumentKey(t)) throw new j(K.INVALID_ARGUMENT, `Invalid collection reference. Collection references must have an odd number of segments, but ${t} has ${t.length}.`);
}
...
class Ea {
    constructor(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, wa("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    isEqual(t) {
 ...
 */ class Ta {
    ...
    constructor(t, e) {
        ...
        this._settingsFrozen = !1, t instanceof la ? this._databaseId = t : (this._app = t, 
        this._databaseId = function(t) {
            ...
            return new la(t.options.projectId);
        }
        /**
 ...
 */
        return function(t) {
            const e = fa.get(t);
            e && ($("ComponentProvider", "Removing Datastore"), fa.delete(t), e.terminate());
...
function Ia(t, e, n, s = {}) {
    var i;
    const r = (t = ya(t, Ta))._getSettings();
 ...
 */ class Aa {
     ...
     */    get parent() {
        return new ba(this.firestore, this.converter, this._key.path.popLast());
    }
    withConverter(t) {
        return new Aa(this.firestore, t, this._key);
    }
}
 ...
 */ class Ra {
    ...
    withConverter(t) {
        return new Ra(this.firestore, t, this._query);
    }
}
 ...
 */ class ba extends Ra {
     ...
     */    get parent() {
        ...
        return t.isEmpty() ? null : new Aa(this.firestore, 
        /* converter= */ null, new vt(t));
    }
    withConverter(t) {
        return new ba(this.firestore, t, this._path);
    }
}

function Pa(t, e, ...n) {
    if (t = p(t), da("collection", "path", e), t instanceof Ta) {
        const s = ht.fromString(e, ...n);
        return ma(s), new ba(t, /* converter= */ null, s);
    }
    {
        if (!(t instanceof Aa || t instanceof ba)) throw new j(K.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(ht.fromString(e, ...n));
        return ma(s), new ba(t.firestore, 
        /* converter= */ null, s);
    }
}
 ...
 */ function va(t, e) {
    if (t = ya(t, Ta), da("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new j(K.INVALID_ARGUMENT, `Invalid collection ID '${e}' passed to function collectionGroup(). Collection IDs must not contain '/'.`);
    return new Ra(t, 
    /* converter= */ null, 
    /**
...
function Va(t, e, ...n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (e = tt.I()), da("doc", "path", e), t instanceof Ta) {
        const s = ht.fromString(e, ...n);
        return _a(s), new Aa(t, 
        /* converter= */ null, new vt(s));
    }
    {
        if (!(t instanceof Aa || t instanceof ba)) throw new j(K.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
        const s = t._path.child(ht.fromString(e, ...n));
        return _a(s), new Aa(t.firestore, t instanceof ba ? t.converter : null, new vt(s));
    }
}
 ...
 * Firestore database.
 */ function Sa(t, e) {
    return t = p(t), e = p(e), (t instanceof Aa || t instanceof ba) && (e instanceof Aa || e instanceof ba) && (t.firestore === e.firestore && t.path === e.path && t.converter === e.converter);
}
 ...
 * Firestore database.
 */ function Da(t, e) {
    return t = p(t), e = p(e), t instanceof Ra && e instanceof Ra && (t.firestore === e.firestore && Re(t._query, e._query) && t.converter === e.converter);
}
 ...
 */ class Ca {
    constructor() {
        ...
        this.rr = new Zr(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 */ (t)), t;
    ...
    enqueueAfterDelay(t, e, n) {
        ...
        const s = ko.createAndSchedule(this, t, e, n, (t => this.bc(t)));
 ...
 * limitations under the License.
 */
/** DOMException error code constants. */ const ka = -1;
...
class $a extends Ta {
    ...
    _terminate() {
        ...
        La(this), this._firestoreClient.terminate();
    }
}
 ...
 * @internal
 */ function Ma(t) {
    return t._firestoreClient || La(t), t._firestoreClient.verifyNotTerminated(), t._firestoreClient;
}

function La(t) {
    var e;
    const n = t._freezeSettings(), s = function(t, e, n, s) {
        return new ha(t, e, n, s.host, s.ssl, s.experimentalForceLongPolling, s.experimentalAutoDetectLongPolling, s.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new jc(t._credentials, t._queue, s);
}
 ...
 */ function Ba(t, e) {
    Ja(t = ya(t, $a));
    const n = Ma(t), s = t._freezeSettings(), i = new Mc;
    return qa(n, i, new Oc(i, s.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function Ua(t) {
    Ja(t = ya(t, $a));
    const e = Ma(t), n = t._freezeSettings(), s = new Mc;
    return qa(e, s, new Fc(s, n.cacheSizeBytes));
}
 ...
 */ function qa(t, e, n) {
    ...
    return t.asyncQueue.enqueue((async () => {
        try {
            await Qc(t, n), await Wc(t, e), s.resolve();
        } catch (t) {
            if (!
            /**
...
function Ka(t) {
    ...
    return t._queue.enqueueAndForgetEvenWhileRestricted((async () => {
        try {
            await async function(t) {
                if (!Gs.bt()) return Promise.resolve();
                const e = t + "main";
                await Gs.delete(e);
            }(ir(t._databaseId, t._persistenceKey)), e.resolve();
        } catch (t) {
            e.reject(t);
        }
    })), e.promise;
 ...
 */ function za(t, e) {
    const n = Ma(t = ya(t, $a)), s = new xa;
    return aa(n, t._databaseId, e, s), s;
}
 ...
 */ function Ha(t, e) {
    return ua(Ma(t = ya(t, $a)), e).then((e => e ? new Ra(t, null, e.query) : null));
}
 ...
 */ class Za {
     ...
     */    static fromBase64String(t) {
        try {
            return new Za(mt.fromBase64String(t));
        } catch (t) {
     ...
     */    static fromUint8Array(t) {
        return new Za(mt.fromUint8Array(t));
    }
    /**
...
/** The result of parsing document data (e.g. for a setData call). */ class su {
    constructor(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    toMutation(t, e) {
        return null !== this.fieldMask ? new sn(t, this.data, this.fieldMask, e, this.fieldTransforms) : new nn(t, this.data, e, this.fieldTransforms);
    }
}

/** The result of parsing "update" data (i.e. for an updateData call). */ class iu {
    constructor(t, 
...
/** A "context" object passed around while parsing user data. */ class ou {
    ...
    /** Returns a new context with the specified settings overwritten. */    Nc(t) {
        return new ou(Object.assign(Object.assign({}, this.settings), t), this.databaseId, this.N, this.ignoreUndefinedProperties, this.fieldTransforms, this.fieldMask);
    }
    xc(t) {
        var e;
    ...
    Mc(t) {
        return Pu(t, this.settings.methodName, this.settings.Lc || !1, this.path, this.settings.Bc);
    }
    ...
    $c(t) {
        ...
        if (ru(this.Cc) && nu.test(t)) throw this.Mc('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class cu {
    constructor(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.N = n || Xr(t);
    }
...
/** Parse document data from a set() call. */ function uu(t, e, n, s, i, r = {}) {
    ...
    Iu("Data must be an object, but it was:", o, s);
    const c = Eu(s, o);
    let a, u;
...
class du extends tu {
    ...
    _toFieldTransform(t) {
        const e = lu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => pu(t, e))), s = new Me(n);
...
class wu extends tu {
    ...
    _toFieldTransform(t) {
        const e = lu(this, t, 
        /*array=*/ !0), n = this.qc.map((t => pu(t, e))), s = new Be(n);
        return new Qe(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class _u extends tu {
    ...
    _toFieldTransform(t) {
        const e = new qe(t.N, Ne(t.N, this.Kc));
...
/** Parse update data from an update() call. */ function mu(t, e, n, s) {
    const i = t.Uc(1 /* Update */ , e, n);
    Iu("Data must be an object, but it was:", i, s);
    const r = [], o = qt.empty();
    ct(s, ((t, s) => {
        const c = bu(e, t, n);
...
/** Parse update data from a list of field/value arguments. */ function gu(t, e, n, s, i, r) {
    ...
    for (let t = 0; t < r.length; t += 2) c.push(Au(e, r[t])), a.push(r[t + 1]);
    const u = [], h = qt.empty();
    ...
    const l = new dt(u);
    return new iu(h, l, o.fieldTransforms);
}
 ...
 */ function yu(t, e, n, s = !1) {
    return pu(n, t.Uc(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function pu(t, e) {
    ...
    // from firestore-exp.
    t = p(t))) return Iu("Unsupported field value:", e, t), Eu(t, e);
    if (t instanceof tu) 
 ...
 */
    return function(t, e) {
        ...
        if (!ru(e.Cc)) throw e.Mc(`${t._methodName}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Ne(e.N, t);
        ...
        if (t instanceof Aa) {
            ...
            return {
                referenceValue: Wn(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.Mc(`Unsupported field value: ${ga(t)}`);
    }
    /**
...
function Tu(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof it || t instanceof eu || t instanceof Za || t instanceof Aa || t instanceof tu);
}
 ...
 */ function Au(t, e, n) {
    ...
    // FieldPath.
    e = p(e)) instanceof Ya) return e._internalPath;
    if ("string" == typeof e) return bu(t, e);
 ...
 * evaluated.
 */ function bu(t, e, n) {
    if (e.search(Ru) >= 0) throw Pu(`Invalid field path (${e}). Paths must not contain '~', '*', '/', '[', or ']'`, t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
    try {
        return new Ya(...e.split("."))._internalPath;
    } catch (s) {
 ...
 */ class Vu {
     ...
     */    data() {
        if (this._document) {
            if (this._converter) {
                ...
                const t = new Su(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
    ...
    get(t) {
        if (this._document) {
            const e = this._document.data.field(Du("DocumentSnapshot.get", t));
 ...
 * Helper that calls `fromDotSeparatedString()` but wraps any error thrown.
 */ function Du(t, e) {
    return "string" == typeof e ? bu(t, e) : e instanceof Ya ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ class Nu extends Vu {
     ...
     */    data(t = {}) {
        if (this._document) {
            if (this._converter) {
                // We only want to use the converter and create a new DocumentSnapshot
                // if a converter has been provided.
                const e = new xu(this._firestore, this._userDataWriter, this._key, this._document, this.metadata, 
                /* converter= */ null);
    ...
    get(t, e = {}) {
        if (this._document) {
            const n = this._document.data.field(Du("DocumentSnapshot.get", t));
 ...
 */ class ku {
    /** @hideconstructor */
    constructor(t, e, n, s) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = s, this.metadata = new Cu(s.hasPendingWrites, s.fromCache), 
        this.query = n;
    }
     ...
     */    forEach(t, e) {
        this._snapshot.docs.forEach((n => {
            t.call(e, new xu(this._firestore, this._userDataWriter, n.key, n, new Cu(this._snapshot.mutatedKeys.has(n.key), this._snapshot.fromCache), this.query.converter));
        }));
    }
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((n => ({
                    type: "added",
                    doc: new xu(t._firestore, t._userDataWriter, n.doc.key, n.doc, new Cu(t._snapshot.mutatedKeys.has(n.doc.key), t._snapshot.fromCache), t.query.converter),
                    oldIndex: -1,
                    newIndex: e++
                })));
            }
            {
                ...
                return t._snapshot.docChanges.filter((t => e || 3 /* Metadata */ !== t.type)).map((e => {
                    const s = new xu(t._firestore, t._userDataWriter, e.doc.key, e.doc, new Cu(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter);
                    let i = -1, r = -1;
 ...
 * limitations under the License.
 */ function Fu(t) {
    if (ge(t) && 0 === t.explicitOrderBy.length) throw new j(K.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
        ...
        const e = au(t.firestore), n = function(t, e, n, s, i, r, o) {
            ...
            if (i.isKeyField()) {
                ...
                if ("in" /* IN */ === r || "not-in" /* NOT_IN */ === r) {
                    eh(o, r);
                    const e = [];
                    for (const n of o) e.push(th(s, t, n));
                    c = {
                        arrayValue: {
                            values: e
                        }
            ...
            } else "in" /* IN */ !== r && "not-in" /* NOT_IN */ !== r && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== r || eh(o, r), 
            c = yu(n, e, o, 
 ...
 */
        ...
        return new Ra(t.firestore, t.converter, function(t, e) {
...
class ju extends Mu {
    ...
    _apply(t) {
        return new Ra(t.firestore, t.converter, Ae(t._query, this.zc, this.Hc));
    }
}
 ...
 * @returns The created {@link Query}.
 */ function Qu(t) {
    return pa("limit", t), new ju("limit", t, "F" /* First */);
}
 ...
 * @returns The created {@link Query}.
 */ function Wu(t) {
    return pa("limitToLast", t), new ju("limitToLast", t, "L" /* Last */);
}
...
class Gu extends Mu {
    ...
    _apply(t) {
        const e = Zu(t, this.type, this.Jc, this.Yc);
        return new Ra(t.firestore, t.converter, function(t, e) {
...
function Yu(...t) {
    return new Ju("endBefore", t, /*before=*/ !0);
}

function Xu(...t) {
    return new Ju("endAt", t, /*before=*/ !1);
}

/** Helper function to create a bound from a document or fields */ function Zu(t, e, n, s) {
    if (n[0] = p(n[0]), n[0] instanceof Vu) return function(t, e, n, s, i) {
        ...
        // results.
                for (const n of Te(t)) if (n.field.isKeyField()) r.push($t(e, s.key)); else {
        ...
        return function(t, e, n, s, i, r) {
            ...
            for (let r = 0; r < i.length; r++) {
                ...
                if (o[r].field.isKeyField()) {
                    ...
                    if (!Ee(t) && -1 !== a.indexOf("/")) throw new j(K.INVALID_ARGUMENT, `Invalid query. When querying a collection and ordering by FieldPath.documentId(), the value passed to ${s}() must be a plain document ID, but '${a}' contains a slash.`);
                    const n = t.path.child(ht.fromString(a));
                    if (!vt.isDocumentKey(n)) throw new j(K.INVALID_ARGUMENT, `Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to ${s}() must result in a valid document path, but '${n}' is not because it contains an odd number of segments.`);
                    const i = new vt(n);
                    c.push($t(e, i));
                } else {
                    const t = yu(n, s, a);
...
function th(t, e, n) {
    if ("string" == typeof (n = p(n))) {
        ...
        if (!Ee(e) && -1 !== n.indexOf("/")) throw new j(K.INVALID_ARGUMENT, `Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but '${n}' contains a '/' character.`);
        const s = e.path.child(ht.fromString(n));
        if (!vt.isDocumentKey(s)) throw new j(K.INVALID_ARGUMENT, `Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '${s}' is not because it has an odd number of segments (${s.length}).`);
        return $t(t, new vt(s));
    }
    if (n instanceof Aa) return $t(t, n._key);
    throw new j(K.INVALID_ARGUMENT, `Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: ${ga(n)}.`);
}
 ...
 */ class sh {
    ...
    convertGeoPoint(t) {
        return new eu(pt(t.latitude), pt(t.longitude));
    }
    convertArray(t, e) {
    ...
    convertDocumentKey(t, e) {
        ...
        B(Ts(n));
        const s = new la(n.get(1), n.get(3)), i = new vt(n.popFirst(5));
        return s.isEqual(e) || 
...
class rh extends sh {
    ...
    convertReference(t) {
        ...
        return new Aa(this.firestore, /* converter= */ null, e);
    }
}
 ...
 */ class oh {
    ...
    set(t, e, n) {
        ...
        const s = ch(t, this._firestore), i = ih(s.converter, e, n), r = uu(this._dataReader, "WriteBatch.set", s._key, i, null !== s.converter, n);
        return this._mutations.push(r.toMutation(s._key, ze.none())), this;
    }
    update(t, e, n, ...s) {
        this._verifyNotCommitted();
        const i = ch(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof Ya ? gu(this._dataReader, "WriteBatch.update", i._key, e, n, s) : mu(this._dataReader, "WriteBatch.update", i._key, e), 
     ...
     */    delete(t) {
        this._verifyNotCommitted();
        const e = ch(t, this._firestore);
        return this._mutations = this._mutations.concat(new an(e._key, ze.none())), this;
    }
    /**
...
function ch(t, e) {
    if ((t = p(t)).firestore !== e) throw new j(K.INVALID_ARGUMENT, "Provided document reference is from a different Firestore instance.");
    return t;
}
...
function ah(t) {
    t = ya(t, Aa);
    const e = ya(t.firestore, $a);
    return sa(Ma(e), t._key).then((n => Ih(e, t, n)));
}
 ...
 */ function hh(t) {
    t = ya(t, Aa);
    const e = ya(t.firestore, $a), n = Ma(e), s = new uh(e);
    return na(n, t._key).then((n => new Nu(e, s, t._key, n, new Cu(null !== n && n.hasLocalMutations, 
 ...
 */ function fh(t) {
    t = ya(t, Ra);
    const e = ya(t.firestore, $a), n = Ma(e), s = new uh(e);
    return Fu(t._query), ra(n, t._query).then((n => new ku(e, s, t, n)));
}
 ...
 */ function dh(t) {
    t = ya(t, Ra);
    const e = ya(t.firestore, $a), n = Ma(e), s = new uh(e);
    return ia(n, t._query).then((n => new ku(e, s, t, n)));
}
 ...
 */ function wh(t) {
    ...
    return ra(n, t._query, {
        source: "server"
    }).then((n => new ku(e, s, t, n)));
}

function _h(t, e, n) {
    t = ya(t, Aa);
    const s = ya(t.firestore, $a), i = ih(t.converter, e, n);
    return Th(s, [ uu(au(s), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, ze.none()) ]);
}

function mh(t, e, n, ...s) {
    t = ya(t, Aa);
    const i = ya(t.firestore, $a), r = au(i);
    let o;
    o = "string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = p(e)) || e instanceof Ya ? gu(r, "updateDoc", t._key, e, n, s) : mu(r, "updateDoc", t._key, e);
    return Th(i, [ o.toMutation(t._key, ze.exists(!0)) ]);
}
 ...
 */ function gh(t) {
    return Th(ya(t.firestore, $a), [ new an(t._key, ze.none()) ]);
}
 ...
 */ function yh(t, e) {
    const n = ya(t.firestore, $a), s = Va(t), i = ih(t.converter, e);
    return Th(n, [ uu(au(t.firestore), "addDoc", s._key, i, null !== t.converter, {}).toMutation(s._key, ze.exists(!1)) ]).then((() => s));
}
...
function ph(t, ...e) {
    ...
    "object" != typeof e[o] || Na(e[o]) || (r = e[o], o++);
    const c = {
    ...
    let a, u, h;
    if (t instanceof Aa) u = ya(t.firestore, $a), h = _e(t._key.path), a = {
        next: n => {
            e[o] && e[o](Ih(u, t, n));
        },
        error: e[o + 1],
        ...
        const n = ya(t, Ra);
        u = ya(n.firestore, $a), h = n._query;
        const s = new uh(u);
        a = {
            next: t => {
                e[o] && e[o](new ku(u, s, n, t));
            },
            error: e[o + 1],
            complete: e[o + 2]
        }, Fu(t._query);
    ...
    return function(t, e, n, s) {
        const i = new Bc(s), r = new Wo(e, i, n);
        return t.asyncQueue.enqueueAndForget((async () => Uo(await Zc(t), r))), () => {
            i.Xo(), t.asyncQueue.enqueueAndForget((async () => qo(await Zc(t), r)));
        };
    }(Ma(u), h, c, a);
}

function Eh(t, e) {
    return oa(Ma(t = ya(t, $a)), Na(e) ? e : {
        next: e
    });
}
 ...
 */ function Ih(t, e, n) {
    const s = n.docs.get(e._key), i = new uh(t);
    return new Nu(t, i, e._key, s, new Cu(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ class Ah extends class {
     ...
     */    get(t) {
        const e = ch(t, this._firestore), n = new rh(this._firestore);
    ...
    set(t, e, n) {
        const s = ch(t, this._firestore), i = ih(s.converter, e, n), r = uu(this._dataReader, "Transaction.set", s._key, i, null !== s.converter, n);
    ...
    update(t, e, n, ...s) {
        ...
        // performing validation.
                let r;
        return r = "string" == typeof (e = p(e)) || e instanceof Ya ? gu(this._dataReader, "Transaction.update", i._key, e, n, s) : mu(this._dataReader, "Transaction.update", i._key, e), 
     ...
     * @returns A `DocumentSnapshot` with the read data.
     */    get(t) {
        const e = ch(t, this._firestore), n = new uh(this._firestore);
        return super.get(t).then((t => new Nu(this._firestore, n, e._key, t._document, new Cu(
        /* hasPendingWrites= */ !1, 
 ...
 * writes.
 */ function Dh(t) {
    return Ma(t = ya(t, $a)), new oh(t, (e => Th(t, e)));
}
...
Ch = "rn", function(t) {
    ...
    const n = t.getProvider("app").getImmediate(), s = new $a(n, new H(t.getProvider("auth-internal")));
