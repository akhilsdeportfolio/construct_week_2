...
- [LIVE DEMO](https://nordstrom-cloned.herokuapp.com/landingpage)
...
To start using the application, open the [click here](https://nordstrom-cloned.herokuapp.com/) and select > Home category > Art wall and Home decor sub category in navbar.
