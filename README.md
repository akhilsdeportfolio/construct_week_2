...
To start using the application, open the <a>[click here](https://nordstrom-cloned.herokuapp.com/)</a> and select > Home category > Art wall and Home decor sub category in navbar.
