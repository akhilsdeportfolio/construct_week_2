...
To start using the application, open the <a href="https://nordstrom-cloned.herokuapp.com/" target="_blank">[click here](https://nordstrom-cloned.herokuapp.com/)</a> and select > Home category > Art wall and Home decor sub category in navbar.
